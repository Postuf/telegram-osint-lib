...
{
    public function test_create_authkey_v2_authorized(): void
    {
        ...
        self::assertInstanceOf(AuthKey_v2_Authorized::class, $authKey);
    }

    public function test_create_authkey_v2_phone(): void
    {
        /** @noinspection PhpUnhandledExceptionInspection */
        ...
        self::assertInstanceOf(AuthKey_v2_Phone::class, $authKey);
    }

    public function test_create_authkey_v2(): void
    {
        /** @noinspection PhpUnhandledExceptionInspection */
        ...
        self::assertInstanceOf(AuthKey_v2::class, $authKey);
    }

    public function test_create_authkey_v1_extended(): void
    {
        /** @noinspection PhpUnhandledExceptionInspection */
        ...
        self::assertInstanceOf(AuthKey_v1_Extended::class, $authKey);
    }

    public function test_create_authkey_v1_simple(): void
    {
        /** @noinspection PhpUnhandledExceptionInspection */
        ...
        self::assertInstanceOf(AuthKey_v1_Simple::class, $authKey);
    }

    public function test_create_authkey_v0(): void
    {
        /** @noinspection PhpUnhandledExceptionInspection */
        ...
        self::assertInstanceOf(AuthKey_v0_RawB64::class, $authKey);
    }
}
